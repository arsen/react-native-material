...
public class RNMaterialIcons extends ReactContextBaseJavaModule {

  private static final Map<String, Typeface> sTypefaceCache = new HashMap<String, Typeface>();

  public static final String REACT_CLASS = "RNMaterialIcons";
  ...
  public RNMaterialIcons(ReactApplicationContext reactContext) {
    super(reactContext);
  }
